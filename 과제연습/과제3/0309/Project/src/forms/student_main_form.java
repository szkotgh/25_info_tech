...
public class student_main_form extends aframe {
   int cnt = 1;   
   String ln[] = {"질문 등록", "내 질문", "문제퀴즈", "오답노트"};
         ...
         jl.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
               if (a == 0) {
                  ...
                  new student_quiz_form();
               } else {
                  new student_wrong_answer_note_form();
               }
               th.interrupt();
               dispose();
            }
