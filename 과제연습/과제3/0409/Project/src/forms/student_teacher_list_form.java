	...
	private void dup() {
		...
		try {
			...
			while (rs.next()) {
				...
				p2.add(jl = new JLabel("�̸� : " + rs.getString(2), 0));
				ft(jl, 0, 13);
				p2.add(jl = new JLabel("�з� : " + rs.getString(3), 0));
				ft(jl, 0, 13);
				emp(p2, 20, 0, 20, 0);
				...
				p1.add(p2 = new JPanel( new GridLayout(0,1,5,10)), c);
				p2.add(jl = new JLabel("�� ����Ǯ���� ���� : " + rs.getString(4) + "��"));
				ft(jl, 0, 11);
				p2.add(jl = new JLabel("�亯�� : " + rs.getString(5) + "%"));
				ft(jl, 0, 11);
				fk(jl, Color.red);
				emp(p2, 10, 15,10, 0);
			}
