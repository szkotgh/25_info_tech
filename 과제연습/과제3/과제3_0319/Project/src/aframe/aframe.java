...
public class aframe extends JFrame implements ActionListener, WindowListener, MouseListener, Runnable {
	...
	public void ft(JComponent c, int style, int size) {
		c.setFont(new Font("¸¼Àº °íµñ", style, size));
	}
	
	public void ft2(JComponent c, int style, int size) {
		c.setFont(new Font("Calibri", style, size));
	}
